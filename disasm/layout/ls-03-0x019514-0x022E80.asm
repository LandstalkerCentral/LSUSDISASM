...
loc_1A0F2:
                ...
                cmpi.w  #$299,(CURRENT_MAP).l
                bne.w   loc_1A1A6
                move.b  (P2_INPUT).l,d0 
                cmpi.b  #$E0,d0
                beq.w   return_1A308
                lea     (byte_FF5480).l,a0
                move.b  #$4F,$8B(a0) 
