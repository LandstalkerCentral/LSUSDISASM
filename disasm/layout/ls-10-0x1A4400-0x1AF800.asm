...
; GAME SECTION 10 :
; 0x1A4400..0x1AF800 : Code to figure out, Sprite Palettes
...
loc_1A4518:
    ...
    ; End of function sub_1A4468
                ...
                include "data\graphics\sprites\spritepalettes.asm"    ; Sprite Palette Map
                include "data\graphics\sprites\palettes\entries.asm"    ; Sprite Palette Entries
