...
; GAME SECTION 04 :
; 0x022E80..0x038600 : To figure out and describe succinctly
; FREE SPACE : 628 bytes.


p_pt_TextBanks: dc.l pt_TextBanks
p_MainFont:     dc.l MainFont           
...
loc_22F2C:
                ...
                movem.l d0-a6,-(sp)
                bsr.w   sub_22FCC
                cmpi.b  #1,(TEXT_LINE_COMPRESSED_LENGTH).l
                beq.w   loc_2308E
                bsr.w   sub_2469C
...
sub_22FCC:
                ...
                bsr.s   GetTextLinePointer
                bsr.s   sub_22FF2
                rts

    ; End of function sub_22FCC
...
sub_22FF2:
                ...
                clr.b   (byte_FF1155).l
                move.b  (a0)+,(TEXT_LINE_COMPRESSED_LENGTH).l
                move.l  #word_FF1196,(dword_FF184C).l
                move.b  #1,d1
                add.b   d1,d1
                or.b    d1,(byte_FF1144).l
                rts
...
GetTextLinePointer:
                ...
                movem.w d0,-(sp)
                lsr.w   #6,d0
                andi.b  #$FC,d0         ; 64 lines per bank
...
loc_23034:
                ...
                tst.b   d0
                beq.s   return_23042
                moveq   #0,d7           ; first byte of each line defines compressed data length
                move.b  (a0),d7
                adda.l  d7,a0
                subq.b  #1,d0
                bra.s   loc_23034
return_23042:
    ...
    ; End of function GetTextLinePointer
...
loc_230D6:
                ...
                cmpi.b  #$47,d0 
                bne.s   loc_230F4
                andi.b  #1,(byte_FF1144).l
                ori.b   #$22,(byte_FF1144).l 
                move.b  #1,(byte_FF1155).l
loc_230F4:
...
sub_232E0:
                ...
                move.w  #$148,d0
                addq.b  #8,(word_FF1800).l
                tst.b   (word_FF1800).l
                bpl.s   loc_232F4
                clr.w   d0
loc_232F4:
                
                move.w  d0,(word_FF0560).l
                move.b  #5,(byte_FF0562).l
                move.w  #$E524,(word_FF0564).l
                move.w  #$1A0,(word_FF0566).l
                rts
...
sub_234B2:
                ...
                move.b  #1,(byte_FF1129).l
                move.b  #$B,(byte_FF112A).l
                bsr.s   sub_2349E
                bcs.s   loc_234E6
                lea     word_23B80(pc), a0
                lea     (byte_FF2700).l,a1
                move.w  #5,d7
                clr.w   d1
                bra.s   loc_234F8
loc_234E6:
                
                lea     word_23900(pc), a0
                lea     (byte_FF2600).l,a1
                move.w  #7,d7
                move.w  #$6000,d1
loc_234F8:
...
sub_23510:
                ...
                lea     word_238E0(pc), a0
                lea     (byte_FF0568).l,a1
                move.w  #$F,d0
loc_2351E:
...
sub_2469C:
                ...
                move.b  #$55,(byte_FF1900).l 
                clr.w   (STRING_BIT_COUNTER).l
                clr.w   (word_FF1920).l
                rts

    ; End of function sub_2469C
...
DecodeHuffmanSymbol:
                ...
                clr.w   d1
                move.b  -$22(a3),d1     ; Get last decoded text symbol -> huffman tree to use
                add.w   d1,d1
...
loc_246E6:
                ...
                bcs.s   loc_24710       ; C = 1 --> Leaf node, go get symbol
...
loc_246F2:
                ...
                bcc.s   loc_246DE       ; C = 0 --> Travel left, go get next Huffman tree bit
                                        ; C = 1 --> Travel right, count left side symbols to skip
                clr.w   d4              ; Clear non-leaf node counter
loc_246F8:
                
                dbf     d3,loc_24700    ; count left sub-tree symbols to skip
                moveq   #7,d3
                move.b  (a1)+,d2        ; Load next huffman tree byte
loc_24700:
                
                add.b   d2,d2           ; Get next Huffman tree bit into Carry
                bcs.s   loc_24708       ; C = 1 --> leaf-node, go add one symbol to skip
...
loc_24708:
                ...
                dbf     d4,loc_246F8    ; Continue until all nodes in left subtree exhausted
                bra.s   loc_246DE       ; Examine next tree node
loc_24710:
                ...
                move.b  d0,-$22(a3)     ; save decoded symbol
                movem.l (sp)+,d1-d7/a1-a3
                rts

    ; End of function DecodeHuffmanSymbol
...
sub_24724:
                ...
                bsr.w   sub_24998
                move.w  #$50,(word_FF1194).l 
                move.w  #0,d0
                jsr     sub_22EC8
                move.w  #$A0,(word_FF1194).l 
                move.w  #1,d0
                jsr     sub_22EC8
                ...
                move.b  #5,(byte_FF0562).l
                move.w  #$E524,(word_FF0564).l
                move.w  #$D0,(word_FF0566).l 
                clr.b   (word_FF1800).l
                clr.b   d2
loc_24778:
                
                move.w  d1,(word_FF0560).l
                tst.b   (word_FF1800).l
                bpl.s   loc_2478C
                clr.w   (word_FF0560).l
loc_2478C:
...
byte_247D4:
                ...
                clr.w   (word_FF0560).l
                cmpi.w  #$D1,(word_FF0566).l 
                rts
loc_247E8:
                
                cmpi.w  #$120,(word_FF0566).l
                beq.s   loc_247CC
                move.w  #$120,(word_FF0566).l
                clr.b   (word_FF1800).l
                bra.w   loc_24778
loc_24804:
                
                cmpi.w  #$D0,(word_FF0566).l 
                beq.w   loc_247CC
                move.w  #$D0,(word_FF0566).l 
                clr.b   (word_FF1800).l
                bra.w   loc_24778
...
sub_2482C:
                ...
                ext.w   d1
                addi.w  #$134,d1
                move.b  #5,(byte_FF07CA).l
                move.w  #$8524,(word_FF07CC).l
                move.w  #$D0,(word_FF07CE).l 
                move.w  d1,(word_FF07C8).l
...
loc_24916:
                ...
                cmpi.w  #$120,(word_FF07CE).l
                beq.w   loc_248EE
                move.w  #$120,(word_FF07CE).l
                move.b  #5,(byte_FF07CA).l
                move.w  #$8524,(word_FF07CC).l
                clr.b   (word_FF1800).l
                movem.w d1-d2,-(sp)
...
sub_252B0:
                ...
                movem.l d0/a0-a2,-(sp)
                bsr.w   sub_25318
                lea     (byte_FF1906).l,a0
                lea     (byte_FF190E).l,a1
                moveq   #7,d0
loc_252C6:
...
sub_27336:
                ...
                move.w  #$138,(word_FF1926).l
                rts

    ; End of function sub_27336
...
sub_2734C:
                ...
                bsr.w   sub_25D96
                bchg    d0,(a3)+
                dc.w $190B              ; " move.b a3,-(a4)" considered as illegal adressing mode by assembler asm68k
                move.b  d5,-(a4)
                rts

    ; End of function sub_2734C
...
loc_276D6:
                ...
                move.b  d0,(byte_FF1904).l
                rts

    ; End of function sub_276BC
...
loc_28D90:
    ...
    ; End of function sub_28D64

off_28D9C:      dc.w sub_28DBE-off_28D9C
                dc.w sub_28DE4-off_28D9C
                dc.w sub_28E0A-off_28D9C
                dc.w sub_28E30-off_28D9C
                dc.w sub_28E56-off_28D9C
                dc.w sub_28E7C-off_28D9C
                dc.w sub_28F14-off_28D9C
                dc.w sub_28F50-off_28D9C
...
loc_28EAC:
    ...
    ; End of function sub_28E7C

off_28EB2:      dc.w sub_28EBA-off_28EB2
                dc.w sub_28EE0-off_28EB2
                dc.w byte_28F08-off_28EB2
                dc.w byte_28F0E-off_28EB2
...
loc_28F62:
                ...
                move.w  d0,(word_FF1926).l
                movem.l (sp)+,d0-d1/a1
                rts

    ; End of function sub_28F50
...
sub_28FB8:
                ...
                beq.s   loc_28FD2
                bsr.w   sub_22EA0
                bclr    #0,(byte_FF1902).l
loc_28FD2:
                
                movem.l (sp)+,d0-a6
                rts

    ; End of function sub_28FB8
...
sub_2900A:
                ...
                btst    #1,(byte_FF1902).l
                bne.s   return_29024
                sndCom  SOUND_COMMAND_STOP_MUSIC
                bsr.w   sub_29CC4
                bset    #1,(byte_FF1902).l
return_29024:
                
                rts

    ; End of function sub_2900A
...
sub_2912C:
                ...
                move.l  d0,-(sp)
                subi.w  #$3E8,d0
                move.b  byte_2913E(pc,d0.w),(byte_FF1154).l
                move.l  (sp)+,d0
                rts

    ; End of function sub_2912C
...
sub_294CA:
                ...
                move.l  d1,-(sp)
                lea     word_294E6(pc), a2
loc_294D0:
                
                move.w  (a2)+,d1
                move.w  (a2)+,d7
                blt.s   loc_294DE
                cmp.w   (word_FF1206).l,d7
                bne.s   loc_294D0
loc_294DE:
...
loc_29BF0:
                ...
                move.w  d0,(a0)+
                dbf     d1,loc_29BF0
                lea     (byte_FF2D40).l,a0
                lea     byte_29C78(pc), a1
                movem.w (a1)+,d1-d7
                bsr.w   sub_2A206
                movem.w (a1)+,d5/d7
                bsr.w   sub_2A206
...
sub_29CC4:
                ...
                moveq   #3,d4
                bsr.w   sub_2A020
                lea     (byte_FF1A84).l,a0
                lea     (byte_FF1B0C).l,a1
                move.w  #$F,d1
loc_29CF0:
...
sub_2A464:
                ...
                move.w  d1,d0
                asl.w   #2,d0
                move.w  word_2A49A(pc,d0.w),d0
                bsr.w   sub_28FD8
                rts

    ; End of function sub_2A464
...
sub_2A47E:
                ...
                move.w  d1,d0
                asl.w   #2,d0
                move.w  word_2A49C(pc,d0.w),d0
                jsr     word_2A49A(pc,d0.w)
                rts

    ; End of function sub_2A47E
...
sub_2A562:
                ...
                bsr.w   sub_28FD8
                clr.l   (dword_FF1878).l
                move.b  byte_2A5A0(pc,d1.w),(dword_FF1878+3).l
                move.w  #$20,d0 
                bsr.w   sub_28FD8
                rts

    ; End of function sub_2A562
...
loc_2A718:
                ...
                clr.l   (a0)+
                dbf     d0,loc_2A718
                lea     word_2A782(pc), a0
                add.w   d1,d1
                move.w  word_2A762(pc,d1.w),d1
                blt.s   loc_2A734
loc_2A72A:
...
sub_2A754:
    ...
    ; End of function sub_2A754

word_2A762:     dc.w $FFFF
                dc.w $14
                dc.w $22
                dc.w $23
                dc.w $1D
...
loc_2A7EC:
                ...
                btst    #0,(byte_FF1917).l
                beq.s   loc_2A804
                move.w  (a0),d0
                jsr     (a0,d0.w)
                bclr    #0,(byte_FF1917).l
loc_2A804:
...
loc_2A812:
                ...
                btst    #1,(byte_FF1917).l
                beq.s   loc_2A7EC
                rts

    ; End of function sub_2A7DA
...
loc_2A824:
                ...
                bset    #0,(byte_FF1917).l
                rts

    ; End of function sub_2A81E
...
byte_2A87C:     dc.b 0
                ...
                dc.b   2
                dc.b   2
MainFont:       incbin "data/graphics/tech/fonts/mainfont.bin" ; uncompressed 2bpp graphics, 8x15-pixel characters (30 bytes)
TextBank0:      incbin "data/scripting/text/textbank0.bin" ; Huffman compressed string data
TextBank1:      incbin "data/scripting/text/textbank1.bin"
TextBank2:      incbin "data/scripting/text/textbank2.bin"
TextBank3:      incbin "data/scripting/text/textbank3.bin"
TextBank4:      incbin "data/scripting/text/textbank4.bin"
TextBank5:      incbin "data/scripting/text/textbank5.bin"
TextBank6:      incbin "data/scripting/text/textbank6.bin"
TextBank7:      incbin "data/scripting/text/textbank7.bin"
TextBank8:      incbin "data/scripting/text/textbank8.bin"
pt_TextBanks:   dc.l TextBank0          
                dc.l TextBank1
                dc.l TextBank2
                dc.l TextBank3
                dc.l TextBank4
